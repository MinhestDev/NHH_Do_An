...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <div class="container-fluid" id="print_out">
            ...
            <h3 class="text-info">Hóa đơn: <b><?php echo isset($invoice_code) ? $invoice_code :'' ?></b></h3>
            ...
            <fieldset class="border-bottom border-info">
                ...
                <table class="table table-hover table-striped table-bordered" id="service-list">
                    ...
                    <tfoot>
                        ...
                        <tr class="bg-lightblue text-light disabled">
                            <th class="px-2 py-2 text-right" colspan="3">
                                Mã giảm giá (<?php echo isset($discount_perc) ? $discount_perc : 0 ?>%)
                            </th>
                            <th class="px-2 py-2 text-right discount"><?php echo isset($discount) ? number_format($discount,0) : 0 ?></th>
                        </tr>
                        <tr class="bg-lightblue text-light disabled">
                            <th class="px-2 py-2 text-right" colspan="3">
                            ...
                            <th class="px-2 py-2 text-right tax"><?php echo isset($tax) ? number_format($tax,0) : 0 ?></th>
                        </tr>
                        <tr class="bg-lightblue text-light disabled">
                            <th class="px-2 py-2 text-right" colspan="3">
                                Tổng
                            </th>
                            <th class="px-2 py-2 text-right grand_total"><?php echo isset($total) ? number_format($total,0) : 0 ?></th>
                        </tr>
                    </tfoot>
                </table>
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="pl-4">
                            ...
                            <?php else: ?>
                                <span class="badge badge-pill badge-primary">Đang thanh toán</span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <div class="card-footer text-center">
            ...
            <a class="btn btn-flat btn-sn btn-primary" href="<?php echo base_url."admin?page=invoice/manage_invoice&id=".$id ?>"><i class="fa fa-edit"></i> Sửa</a>
            <a class="btn btn-flat btn-sn btn-dark" href="<?php echo base_url."admin?page=invoice" ?>">Trở lại danh sách</a>
    </div>
</div>
<script>
    $(function(){
