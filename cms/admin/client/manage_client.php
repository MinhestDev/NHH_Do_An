...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h5 class="card-title"><?php echo isset($id) ? "Cập nhật chi tiết - ".$client_code : 'Thêm khách hàng mới' ?></h5>
    </div>
    <div class="card-body">
            ...
            <form action="" id="client-form">
                ...
                <div class="col-md-12">
                    <fieldset class="border-bottom border-info">
                        <legend class="text-info">Thông tin cá nhân</legend>
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <label for="lastname" class="control-label text-info">Tên</label>
                            ...
                            <div class="form-group col-sm-4">
                                <label for="firstname" class="control-label text-info">Họ</label>
                            ...
                            <div class="form-group col-sm-4">
                                <label for="middlename" class="control-label text-info">Tên đệm</label>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <label for="gender" class="control-label text-info">Giới tính</label>
                            ...
                            <div class="form-group col-sm-4">
                                <label for="dob" class="control-label text-info">Ngày sinh</label>
                                <input type="date" class="form-control form-control-sm rounded-0" id="dob" name="dob" value="<?php echo isset($dob) ? $dob : '' ?>" required>
                            </div>
                            <div class="form-group col-sm-4">
                                <label for="contact" class="control-label text-info">Liên hệ #</label>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label for="address" class="control-label text-info">Địa chỉ</label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="status" class="control-label text-info">Trạng thái</label>
                    ...
                    <fieldset class="border-bottom border-info">
                        <legend class="text-info">Ảnh khách hàng</legend>
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <div class="custom-file rounded-0">
                                    ...
                                    <label class="custom-file-label rounded-0" for="avatar">Chọn file</label>
                                </div>
                            </div>
    ...
    <div class="card-footer text-center">
        <button class="btn btn-flat btn-sn btn-primary" type="submit" form="client-form">Lưu</button>
        <a class="btn btn-flat btn-sn btn-dark" href="<?php echo base_url."admin?page=client" ?>">Hủy</a>
    </div>
</div>
<script>
    $(function(){
