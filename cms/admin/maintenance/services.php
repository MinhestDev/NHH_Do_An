...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Bạn có cahwcs muốn xóa?","delete_service",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Thêm dịch vụ","maintenance/manage_service.php","mid-large")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Sửa dịch vụ","maintenance/manage_service.php?id="+$(this).attr('data-id'),"mid-large")
		})
		$('.view_data').click(function(){
			uni_modal("<i class='fa fa-list'></i> Chi tiết dịch vụ","maintenance/view_service.php?id="+$(this).attr('data-id'),"")
		})
