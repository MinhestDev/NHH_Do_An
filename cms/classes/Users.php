...
Class Users extends DBConnection {
	...
	public function save_users(){
		...
		if(empty($id)){
			...
			if($qry){
				...
				$this->settings->set_flashdata('success','Đã lưu chi tiết người dùng.');
				$resp['status'] = 1;
			}else{
				$resp['status'] = 2;
			}
			...
			if($qry){
				$this->settings->set_flashdata('success','Đã cập nhật chi tiết người dùng.');
	...
	public function delete_users(){
		...
		if($qry){
			...
			$this->settings->set_flashdata('success','Đã xóa chi tiết người dùng.');
